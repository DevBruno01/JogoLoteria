                            ...
                            <form method="post" class="user" action="<c:url value="cadastrar/salvausuario"/>">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input name="usuario.nome" value="${usuario.nome}" minlength="4" maxlength="20" type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Nome">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="usuario.senha" value="${usuario.senha}" minlength="6" maxlength="20" type="password" class="form-control form-control-user"
